...
public class MainActivity extends Activity implements View.OnTouchListener, GestureDetector.OnGestureListener, AdapterView.OnItemClickListener {
    ...
    private String TAG = "ElvizLai";
    private View view = null;// 点击的view

    private final String title[] = {"待发送队列", "同步分享设置", "编辑我的资料", "找朋友", "告诉朋友",
    ...
    void InitView() {
         ...
         * 实现该接口
         */
        mylaout.setOnScrollListener(new MyLinearLayout.OnScrollListener() {
            @Override
            ...
            public void doLoosen() {
                ...
                Log.e(TAG, "layoutParams.leftMargin=" + layoutParams.leftMargin);
                // 缩回去
                if (layoutParams.leftMargin < -180 / 2) {
    ...
    void doScrolling(float distanceX) {
        ...
        Log.v(TAG, "layoutParams.leftMargin=" + layoutParams.leftMargin + ",layoutParams_1.leftMargin =" + layoutParams_1.leftMargin);
        ...
        viewTreeObserver.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (!hasMeasured) {
                    ...
                    Log.v(TAG, "MAX_WIDTH=" + MAX_WIDTH + "width=" + window_width);
                    hasMeasured = true;
                }
                return true;
            }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (MotionEvent.ACTION_UP == event.getAction() && isScrolling == true) {
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) layout_left.getLayoutParams();
            // 缩回去  此处的180与activity_main中的android:layout_marginLeft="180dp"相一致，判定为，拉出一半松手的话就自动弹开，否则自动缩回去
            if (layoutParams.leftMargin < -180 / 2) {
                new AsynMove().execute(-SPEED);
            } else {
                new AsynMove().execute(SPEED);
    ...
    class AsynMove extends AsyncTask<Integer, Integer, Void> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (values[0] > 0) {
                ...
                Log.v(TAG, "layout_left右" + layoutParams.leftMargin + ",layout_right右" + layoutParams_1.leftMargin);
            } else {
                // 左移动
                ...
                Log.v(TAG, "layout_left左" + layoutParams.leftMargin + ",layout_right左" + layoutParams_1.leftMargin);
            }
            layout_right.setLayoutParams(layoutParams_1);
            layout_left.setLayoutParams(layoutParams);
